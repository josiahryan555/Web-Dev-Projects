...
const minimatch = require('karma-coverage/node_modules/minimatch')
const path = require('path')
const globalSourceMapStore = require('karma-coverage/lib/source-map-store')
const globalCoverageMap = require('karma-coverage/lib/coverage-map')
